package com.ranamahadahmer.weatherapp
...
import com.ranamahadahmer.weatherapp.databinding.ActivityMainBinding
import com.ranamahadahmer.weatherapp.models.WeatherResponse
import com.ranamahadahmer.weatherapp.network.WeatherService
    ...
    private fun setupUI() {
        ...
        if (!weatherResponseJsonString.isNullOrEmpty()) {
            ...
            for (z in weatherList.weather.indices) {
                ...
                binding.tvMain.text = weatherList.main.tempMin.toString() + " min"
